...
c.execute('''CREATE TABLE questions
                (id text, content text, answer text, points integer)''')
...
#enter 2 dummy teams
c.execute("INSERT INTO teams VALUES (?, ?, ?, ?, ?)", ('Wantirna', 0, 0, 0, 'red'))
c.execute("INSERT INTO teams VALUES (?, ?, ?, ?, ?)", ('Boronia', 0, 0, 0, 'blue'))
